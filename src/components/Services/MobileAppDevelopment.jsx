...
import { Smartphone, RefreshCcw, Wrench } from "lucide-react";
  ...
  const services = [
    {
      ...
      desc: "Tailor-made mobile apps for iOS and Android with smooth performance."
    },
    {
      icon: <RefreshCcw className="w-8 h-8 text-green-500" />,
      title: "Progressive Web Apps (PWA)",
      desc: "Cross-platform PWAs that work seamlessly across devices and browsers."
    },
    {
      icon: <Wrench className="w-8 h-8 text-green-500" />,
      title: "App Maintenance",
      desc: "Continuous updates, bug fixes, and optimization for your apps."
    },
  ];
    ...
    >
      ...
      <div className="textblock text-center">
        <div className="container mx-auto">
          <h1 className="text-5xl font-bold capitalize">Mobile App Development Services</h1>
        </div>
      </div>
      ...
      <div className="max-w-6xl mt-4 mx-auto text-center">
        ...
        <p className="text-gray-600 mb-12">
          We build mobile solutions that engage users and drive business growth.
        </p>
